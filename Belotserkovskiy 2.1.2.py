...
class Report:
    ...
    def generate_excel(self):
        ...
        #     data.append([self.stats5[index][0], self.stats5[index][1], '', self.stats6[index][0], self.stats6[index][1]])
    ...
    def generate_image(self):
        ...
        bar2 = ax1.bar(np.array(list(self.stats1)), self.stats3.values(), width=0.4)
        ...
        bar2 = ax2.bar(np.array(list(self.stats2)), self.stats4.values(), width=0.4)
